...
public class ContextManager {
    public static final float VILLAGE_SEARCH_RADIUS = 100;
    ...
    private static LocationContext getLocationContext(Villager villager){
        ...
        if(villagersInRange.size() < VILLAGE_SEARCH_COUNT) return LocationContext.WILD;

        if(!hasBed(villager)) return LocationContext.WILD;
