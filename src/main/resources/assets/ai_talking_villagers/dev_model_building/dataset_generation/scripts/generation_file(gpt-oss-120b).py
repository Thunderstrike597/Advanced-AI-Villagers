...
BASE_SLEEP = 2  # safe default (IMPORTANT for rate limits)
MAX_ENTRIES = 50
...
CONTEXTS = [
    ...
    "Loc=Village, Time=Day, Shelter=Outside, Threat=None, Health=Full, Profession=Farmer, TradeLevel=Novice, Home=Housed, Age=Adult, Rep=Neutral, Weather=Clear, Activity=Wandering, RecentEvent=Raid",
    "Loc=Village, Time=Day, Shelter=Outside, Threat=None, Health=Hurt, Profession=Armorer, TradeLevel=Journeyman, Home=Housed, Age=Adult, Rep=Neutral, Weather=Clear, Activity=Wandering, RecentEvent=Raid",
    ...
    "Loc=Village, Time=Day, Shelter=Outside, Threat=Raid, Health=Full, Profession=Weaponsmith, TradeLevel=Master, Home=Housed, Age=Adult, Rep=Neutral, Weather=Clear, Activity=Working, RecentEvent=None",
    "Loc=Village, Time=Day, Shelter=Outside, Threat=Raid, Health=Full, Profession=Unemployed, TradeLevel=Novice, Home=Housed, Age=Child, Rep=Neutral, Weather=Clear, Activity=Wandering, RecentEvent=None",
    "Loc=Village, Time=Day, Shelter=Outside, Threat=Raid, Health=Critical, Profession=Toolsmith, TradeLevel=Novice, Home=Homeless, Age=Adult, Rep=Neutral, Weather=Rain, Activity=Wandering, RecentEvent=None",
    ...
    "Loc=Village, Time=Morning, Shelter=Outside, Threat=None, Health=Full, Profession=Unemployed, TradeLevel=Novice, Home=Housed, Age=Adult, Rep=Neutral, Weather=Clear, Activity=Wandering, RecentEvent=Raid",
    ...
    "Loc=Village, Time=Dusk, Shelter=Outside, Threat=None, Health=Full, Profession=Unemployed, TradeLevel=Novice, Home=Housed, Age=Adult, Rep=Neutral, Weather=Rain, Activity=Wandering, RecentEvent=Raid",
    ...
    "Loc=Village, Time=Night, Shelter=Outside, Threat=Raid, Health=Full, Profession=Mason, TradeLevel=Novice, Home=Housed, Age=Adult, Rep=Neutral, Weather=Clear, Activity=Wandering, RecentEvent=None",
    "Loc=Village, Time=Night, Shelter=Outside, Threat=Raid, Health=Critical, Profession=Leatherworker, TradeLevel=Novice, Home=Housed, Age=Adult, Rep=Neutral, Weather=Rain, Activity=Wandering, RecentEvent=None",
    ...
    "Loc=Village, Time=Night, Shelter=Outside, Threat=None, Health=Full, Profession=Unemployed, TradeLevel=Novice, Home=Homeless, Age=Adult, Rep=Neutral, Weather=Clear, Activity=Wandering, RecentEvent=Raid",
...
RecentEvent=Raid → shaken up, but relieved. The village was recently raided. 
...
Threat=Zombie_Villager + "how are you"
  ...
  RIGHT: "Hrrm! Are you SERIOUSLY asking that right now?! I'm being chased by ONE OF MY OWN!"

Threat=Zombie_Villager + "where are we?"
  WRONG: "A villager turned last night..."
  RIGHT: "That shouldn't MATTER right now! I'm being CHASE! HElP me.. "
...
Weather=Snow + "how are you" + Age=Child
  ...
  RIGHT: "I'm good! It's so snowwy! I love snow!"

Activity=Sleeping + "hello"
  WRONG: "Hmm hmm! Hello friend, lovely to see you!"
  RIGHT: "Hrrm.. what.. it is the middle of the night.."

Activity=Sleeping + "hello" + Age=Child
  WRONG: "Hmm hmm! Hello friend, lovely to see you!"
  RIGHT: "Hrrm! Hi! Oh, I'm meant to be asleep. Sorry."
...
Profession=Cartographer + "what are you doing" + Activity=Working
  WRONG: "Working."
...
Profession=Nitwit + "who are you"
  ...
  RIGHT: "Hmm.. me? That doesn't matter much, I have no purpose.."
...
{lines}"""
    ...
    response = client.chat.completions.create(
        ...
        temperature=0.67,
        max_completion_tokens=16384 * 1.5 # double it
    )
